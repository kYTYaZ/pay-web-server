...
public class AlipayTradePrecreateRequestBuilder extends RequestBuilder {
    ...
    public AlipayTradePrecreateRequestBuilder setRoyaltyInfos(RoyaltyInfo royaltyInfo) {
    ...
    public AlipayTradePrecreateRequestBuilder setSubMerchant(Submerchant subMerchant) {
