...
public class LineGraph implements Graph {
	 ...
	 * @param chartData
	 */
	public LineGraph(ChartData chartData) {
	...
	protected String getJsonString() {
		...
		BigDecimal co = BigDecimal.valueOf(Double.valueOf(0));
		if(max.compareTo(co)<1){
			max=BigDecimal.valueOf(Double.valueOf(1));
			yAxisAttr.put("max", max);
		}else{
			yAxisAttr.put("max", max = BarGraph.ceiling(max, BigDecimal.valueOf(1.05)));
		}
