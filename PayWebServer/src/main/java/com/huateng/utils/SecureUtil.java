   ...
   */
	...
	public static String fillString(String string, char filler,
		...
		for (int i = 0; i < delta; i++) {
			if (atEnd)
				string = new StringBuilder().append(string).append(filler)
						.toString();
			else {
				string = new StringBuilder().append(filler).append(string)
						.toString();
			}
		}
		return string;
				...
				for (i = 0; i < tPinLen - 1;) {
					...
					if (i == tPinLen - 3) {
						String b = new StringBuilder()
								.append(aPin.substring(tPinLen - 1))
								.append("F").toString();
	...
	public static byte[] pin2PinBlockWithCardNO(String aPin, String aCardNO) {
		...
		if (aCardNO.length() == 11)
			aCardNO = new StringBuilder().append("00").append(aCardNO)
					.toString();
		else if (aCardNO.length() == 12) {
			aCardNO = new StringBuilder().append("0").append(aCardNO)
					.toString();
		}
	...
	public String assymEncrypt(String tPIN, String iPan, RSAPublicKey publicKey) {
		System.out.println(new StringBuilder()
				.append("SampleHashMap::assymEncrypt([").append(tPIN)
				.append("])").toString());
		System.out.println(new StringBuilder()
				.append("SampleHashMap::assymEncrypt(PIN =[").append(tPIN)
				.append("])").toString());
		try {
			int tKeyLength = 1024;
			...
			System.out.println(new StringBuilder()
					.append("SampleHashMap::assymEncrypt(EncryptCardNo =[")
					.append(tEncryptPIN).append("])").toString());
