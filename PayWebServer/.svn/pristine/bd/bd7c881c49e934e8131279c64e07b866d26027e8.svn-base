...
public class DateUtils {
	 ...
	 * 日期格式：yyyyMMdd
	 */
	public static String STR_YYYY_MM_DD_2 = "yyyyMMdd";
...
//    private static SimpleDateFormat showDateFormatZHCN = new SimpleDateFormat("yyyy年MM月dd日 HH时mm分ss秒");
	...
	public static String time(Time time) {
		DateFormat fmt = new java.text.SimpleDateFormat("HH:mm:ss");
	...
	public static String getCurDate(Date obj) {
		DateFormat fmt = new java.text.SimpleDateFormat("yyyyMMdd");
	...
	public static String time() {
		String day = null;
		try {
			DateFormat fmt = new java.text.SimpleDateFormat("HHmmss");
...
//		System.out.println(parseDate(date,pattern));
		String dd = "(([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})(((0[13578]|1[02])(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)(0[1-9]|[12][0-9]|30))|(02(0[1-9]|[1][0-9]|2[0-8]))))|((([0-9]{2})(0[48]|[2468][048]|[13579][26])|((0[48]|[2468][048]|[3579][26])00))0229)";
		
		String pattern2 = "yyyyMMdd";
		String str2 = "20001302";
		System.out.println(str2.matches(dd));
