...
public class AlipayTradeCreateRequestBuilder extends RequestBuilder {
    ...
    public AlipayTradeCreateRequestBuilder setBuyerLogonId(String buyerLogonId) {
    ...
    public RoyaltyInfo getRoyaltyInfo() {
        return bizContent.royaltyInfo;
    }

    public AlipayTradeCreateRequestBuilder setRoyaltyInfos(RoyaltyInfo royaltyInfo) {
        bizContent.royaltyInfo = royaltyInfo;
        return this;
    }
    
    public Submerchant getSubMerchant() {
        return bizContent.subMerchant;
    }

    public AlipayTradeCreateRequestBuilder setSubMerchant(Submerchant subMerchant) {
        bizContent.subMerchant = subMerchant;
        return this;
    }
    public static class BizContent {
     ...
     // (推荐使用，相对时间) 支付超时时间，5m 5分钟
        ...
        public String toString() {
            ...
            sb.append(", royaltyInfo='").append(royaltyInfo);
            sb.append(", subMerchant='").append(subMerchant);
            sb.append('}');
            return sb.toString();
        }
    }
