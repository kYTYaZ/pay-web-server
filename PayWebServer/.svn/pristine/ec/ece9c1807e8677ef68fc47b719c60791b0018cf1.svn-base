...
public class AlipayTradeWithHBServiceImpl extends AbsAlipayTradeService {
    ...
    public AlipayTradeWithHBServiceImpl(){
    ...
    public AlipayF2FPayResult tradePay(AlipayTradePayRequestBuilder builder) {
        ...
        if (response != null && Constants.SUCCESS.equals(response.getCode())) {
            ...
            return checkQueryAndCancel(outTradeNo, appAuthToken, result, loopQueryResponse,queryBuiler);
            ...
            return checkQueryAndCancel(outTradeNo, appAuthToken, result, queryResponse,queryBuiler);
	...
	@Override
	public AlipayF2FCloseOrderResult closeOrder(
			AlipayTradeCloseOrderRequestBuilder builder) {
		return null;
	}

	@Override
	public AlipayF2FQueryBillResult queryBill(
			AlipayTradeQueryBillRequestBuilder builder) {
		return null;
	}

	@Override
	public AlipayF2FFastpayRefundQueryResult queryTradeRefund(
			AlipayTradeRefundQueryRequestBuilder builder) {
		return null;
	}
	...
	@Override
	public AlipayF2FCancelResult tradeCancel(
			AlipayTradeCancelRequestBuilder builder) {
		return null;
	}
